...
initialPath = "/home/avi.vajpeyi/pycbcBackgroundTriggers/lalinferencenest/IMRPhenomPv2pseudoFourPN/"
endPath = ["8s/lalinference_1126074549-1129348536.sh","16s/lalinference_1128910595-1128910892.sh","32s/lalinference_1126073757-1129348536.sh","64s/lalinference_1126072701-1129348536.sh"] #
fileToSearch = []
for i,endPathString in enumerate(endPath):
    fileToSearch[i] = initialPath+endPath[i]
...
def adjustDataDumpCommand(commandBreakup, L_shiftedTime):
    ...
    onlinePath = '/home/avi.vajpeyi/testPyCBCtirg/lalinferencenest/IMRPhenomPv2pseudoFourPN/8s/ROQdata/timeshiftedROQfiles/'+ pathSections[ROQfileNumIndex]+"/"
...
def generateNewCommandList(dataMatrix):
    ...
    HOrigTime = dataMatrix[H_TIME]
    LOrigTime = dataMatrix[L_TIME]
    TimeSlideVal = dataMatrix[TIME_SLIDE]
    ...
    SpecificCommandBreakup = OriginalCommandListBreakup
...
onlinePath = '/home/avi.vajpeyi/testPyCBCtirg/lalinferencenest/IMRPhenomPv2pseudoFourPN/8s/ROQdata/timeshiftedROQfiles'
if not os.path.exists(onlinePath):
    os.makedirs(onlinePath)
